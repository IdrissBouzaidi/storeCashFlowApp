...
export class ChargeArrayComponent implements OnChanges {
    ...
    cancelChargeDialogIsVisible: boolean = false;
    ...
    onMenuItemClick(itemName: 'details' | 'cancel' | 'edit') {
        switch (itemName) {
            case 'details':
                break;
            case 'cancel':
                this.cancelChargeDialogIsVisible = true;
    ...
    onConfirmCancelCharge() {
        ...
        this.chargeService.cancelCharge(this.clickedMenuLine!.id!)
            .pipe(
                finalize(() => {
                    this.cancelChargeDialogIsVisible = false;
            ...
            data => {
                this.messageService.add({
                    severity: 'success',
                    summary: 'Charge Cancellation',
                    detail: 'The selected charge has been successfully canceled.'
                });
                this.getData();
            }
        );
