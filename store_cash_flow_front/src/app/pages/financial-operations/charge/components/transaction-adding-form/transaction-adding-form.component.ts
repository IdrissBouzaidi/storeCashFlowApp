...
export class TransactionAddingFormComponent {
    ...
    onSubmit() {
        ...
        if (this.form.invalid) {
            ...
            const addCharge$ = this.chargeService.addCharge(chargeTypeId, cost, shortDesc, consumedBy, transactionDate, transactionTime, quantity, description, imageSrc)?.pipe(
                    tap(
                        (data) => {
