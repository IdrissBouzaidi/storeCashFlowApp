...
import com.idApps.userApi.models.dto.TokenDto;
import com.idApps.userApi.models.request.UserRequest;
import com.idApps.userApi.models.request.UserSummaryRequest;
import com.idApps.userApi.help.utilClasses.HttpHeader;
import com.idApps.userApi.help.constants.HttpConstants;
    ...
    */
    ...
    public ResponseEntity getUserId(String email) {
        ...
        HttpHeader contentTypeHeader = HttpHeader.builder()
                                            ...
                                            .build();
        ResponseEntity responseEntity = this.sendGetOrDeleteRequest(com.idApps.userApi.help.utilEnums.HttpMethod.GET, requestUrl, new HttpHeader[] {authorizationHeader, contentTypeHeader}, List.class);
        try {
...
//        return responseData;
    ...
    private ResponseEntity sendGetOrDeleteRequest(com.idApps.userApi.help.utilEnums.HttpMethod httpMethod, String requestUrl, HttpHeader[] headers, Class responseClass) {
    ...
    private ResponseEntity sendPostOrPutRequest(com.idApps.userApi.help.utilEnums.HttpMethod httpMethod, String requestUrl, HttpHeader[] headers, String requestBody, Class responseClass) {
            WebClient.RequestBodyUriSpec responseWithMethod =
                    switch (httpMethod) {
                        case com.idApps.userApi.help.utilEnums.HttpMethod.POST -> this.webClient.post();
                        case com.idApps.userApi.help.utilEnums.HttpMethod.PUT -> this.webClient.put();
                        default -> null;
                    };
